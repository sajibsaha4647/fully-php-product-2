			...
			<form method="post" action="search-user.php" class="form-inline my-2 my-lg-0" style="margin-top:6px;margin-bottom:20px;">
			  ...
			  <table class="table table-responsive table-striped table-hover table_cus">
					...
					<tbody>
						...
						<?php 
							$sel="SELECT * FROM web_contactus ORDER BY conus_id DESC";
						...
						<tr>
							...
							<td><?= substr($data['conus_mess'],0,100);?>..</td>
							<td>
								<a href="view-mssage.php?v=<?= $data['conus_id'];?>"><i class="fa fa-plus-square fa-lg"></i></a>
